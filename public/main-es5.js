...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["main"], {
  ...
  function srcAppProfesorProfesorComponentTs(module, __webpack_exports__, __webpack_require__) {
    ...
    /*#__PURE__*/
    function () {
      function ProfesorComponent(matDialog, estudiantes, _snackBar, component) {
        ...
        this.displayedColumnsEstudiantes = ['nombre', 'apellidos', 'clase', 'estadisticas', 'acciones', 'borrar']; //Tabla de actividades

        this.displayedColumnsActividades = ['nombre', 'profesor', 'clase', 'estado', 'acciones', 'editar', 'borrar']; //Tabla de clases
