...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("<div *ngIf=\"!verEstadisticasClase\" class=\"row col-12 justify-content-center\">\n    <div class=\"col-3 text-left\">\n        <button *ngIf=\"!editarActividad\" type=\"button\" class=\"btn btn-outline-danger\" (click)=\"cerrarClase()\">Cerrar\n            Clase</button>\n        <button *ngIf=\"editarActividad\" type=\"button\" class=\"btn btn-outline-danger\"\n            (click)=\"cancelar()\">Cancelar</button>\n    </div>\n    <div class=\"col-5 text-right\">\n        <h3 class=\"text-center\">Clase: {{clase.nombre}}</h3>\n    </div>\n    <div class=\"col-2 text-right\">\n        <button type=\"button\" class=\"btn btn-outline-primary text-right\" (click)=\"abrirEstadisticasClase()\"><i\n                class=\"fas fa-chart-bar\"></i>Ver Estadisticas</button>\n    </div>\n    <div class=\"col-2 text-right\">\n        <button type=\"button\" class=\"btn btn btn-outline-success\" (click)=\"crearActividad()\">Crear Actividad</button>\n    </div>\n</div>\n<br *ngIf=\"!verEstadisticasClase\">\n<br *ngIf=\"verEstadisticasClase\">\n<div class=\"col-12\">\n    <app-ver-estadisticas-clase *ngIf=\"verEstadisticasClase\" [clase]=\"clase\"></app-ver-estadisticas-clase>\n</div>\n<div class=\"col-12\">\n    <app-editar-actividad *ngIf=\"editarActividad\" [estudiantes]=\"listaAlumnos\" [editarActividad]=\"actividad\"\n        (actividadEditada)=\"actualizarActividad($event)\">\n    </app-editar-actividad>\n</div>\n<div *ngIf=\"!verEstadisticasClase && !editarActividad\" class=\"row col-12 justify-content-md-center\">\n    <div class=\"col-md-12\">\n        <!--<table class=\"table table-striped\">\n            <thead>\n                <tr>\n                    <th scope=\"col\">Nombre</th>\n                    <th scope=\"col\">Profesor</th>\n                    <th scope=\"col\">Estado</th>\n                    <th scope=\"col\"></th>\n                    <th scope=\"col\"></th>\n                    <th scope=\"col\"></th>\n                </tr>\n            </thead>\n            <tbody *ngFor=\"let actividad of actividades\">\n                <tr *ngIf=\"actividad.estado=='Creada'\">\n                    <td>{{actividad.nombre}}</td>\n                    <td>{{actividad.profesor}}</td>\n                    <td>{{actividad.estado}}</td>\n                    <td><button type=\"button\" class=\"btn btn-outline-primary\"\n                            (click)=\"abrirActividad(actividad)\">Acceder</button></td>\n                    <td><i (click)=\"editarA(actividad)\" class=\"fa fa-edit\"></i></td>\n                    <td><i (click)=\"borrarA(actividad)\" class=\"fa fa-trash-o\"></i></td>\n                </tr>\n                <tr *ngIf=\"actividad.estado=='Comenzada'\">\n                    <td>{{actividad.nombre}}</td>\n                    <td>{{actividad.profesor}}</td>\n                    <td>{{actividad.estado}}</td>\n                    <td><button type=\"button\" class=\"btn btn-outline-success\"\n                            (click)=\"abrirActividad(actividad)\">Ver</button></td>\n                    <td><i (click)=\"editarA(actividad)\" class=\"fa fa-edit\"></i></td>\n                    <td><i (click)=\"borrarA(actividad)\" class=\"fa fa-trash-o\"></i></td>\n                </tr>\n                <tr *ngIf=\"actividad.estado=='Finalizada'\">\n                    <td>{{actividad.nombre}}</td>\n                    <td>{{actividad.profesor}}</td>\n                    <td>{{actividad.estado}}</td>\n                    <td><button type=\"button\" class=\"btn btn-outline-success\"\n                            (click)=\"abrirActividad(actividad)\">Resumen</button></td>\n                    <td><i (click)=\"editarA(actividad)\" class=\"fa fa-edit\"></i></td>\n                    <td><i (click)=\"borrarA(actividad)\" class=\"fa fa-trash-o\"></i></td>\n                </tr>\n            </tbody>\n        </table>-->\n        <div class=\"row\">\n            <div class=\"col-12 example-header\">\n                <mat-form-field>\n                    <input matInput (keyup)=\"applyFilterA($event.target.value)\" placeholder=\"Filtrar\">\n                </mat-form-field>\n            </div>\n            <!--<div class=\"col-3 text-right\">\n                <button type=\"button\" class=\"btn btn-outline-primary\" (click)=\"abrirEstadisticasClase()\"><i\n                        class=\"fas fa-chart-bar\"></i>Ver Estadisticas</button>\n            </div>-->\n        </div>\n        <div class=\"example-container\">\n            <mat-table [dataSource]=\"dataSourceActividades\" class=\"mat-elevation-z1\" matSort>\n                <ng-container matColumnDef=\"nombre\">\n                    <mat-header-cell *matHeaderCellDef mat-sort-header> Nombre </mat-header-cell>\n                    <mat-cell *matCellDef=\"let row\"> {{row.nombre}} </mat-cell>\n                </ng-container>\n\n                <ng-container matColumnDef=\"profesor\">\n                    <mat-header-cell *matHeaderCellDef mat-sort-header> Profesor </mat-header-cell>\n                    <mat-cell *matCellDef=\"let row\"> {{row.profesor}} </mat-cell>\n                </ng-container>\n\n                <ng-container matColumnDef=\"estado\">\n                    <mat-header-cell *matHeaderCellDef mat-sort-header> Clase </mat-header-cell>\n                    <mat-cell *matCellDef=\"let row\"> {{row.estado}} </mat-cell>\n                </ng-container>\n\n                <ng-container matColumnDef=\"acciones\">\n                    <mat-header-cell *matHeaderCellDef mat-sort-header></mat-header-cell>\n                    <mat-cell *matCellDef=\"let row\">\n                        <button *ngIf=\"row.estado=='Creada'\" type=\"button\" class=\"btn btn-sm btn-primary\"\n                            (click)=\"abrirActividad(row)\">Acceder</button>\n                        <button *ngIf=\"row.estado=='Comenzada'\" type=\"button\" class=\"btn btn-sm btn-primary\"\n                            (click)=\"abrirActividad(row)\">Ver</button>\n                        <button *ngIf=\"row.estado=='Finalizada'\" type=\"button\" class=\"btn btn-sm btn-info\"\n                            (click)=\"abrirActividad(row)\">Ver Estadisticas</button>\n                    </mat-cell>\n                </ng-container>\n                <ng-container matColumnDef=\"editarborrar\">\n                    <mat-header-cell *matHeaderCellDef mat-sort-header></mat-header-cell>\n                    <mat-cell *matCellDef=\"let row\">\n                        <div class=\"text-center\">\n                            <i (click)=\"editarA(row)\" class=\"fa fa-edit\"></i>\n                            <i (click)=\"borrarA(row)\" class=\"fa fa-trash-o\"></i>\n                        </div>\n                        \n                    </mat-cell>\n                </ng-container>\n                <mat-header-row *matHeaderRowDef=\"displayedColumnsActividades\"></mat-header-row>\n                <mat-row *matRowDef=\"let row; columns: displayedColumnsActividades;\">\n                </mat-row>\n            </mat-table>\n            <mat-paginator \n            [pageSizeOptions]=\"[10, 25, 100]\"></mat-paginator>\n        </div>\n    </div>\n</div>\n<!--<div class=\"row justify-content-md-center\">\n    <div *ngIf=\"vistaGeneral\" class=\"btn-group btn-group-toggle\">\n        <label class=\"btn btn-outline-primary active\">\n            <input type=\"radio\" name=\"options\" id=\"general\" (click)=\"cambiarAGeneral()\" checked> General\n        </label>\n        <label class=\"btn btn-outline-primary\">\n            <input type=\"radio\" name=\"options\" id=\"mapa_de_clase\" (click)=\"cambiarAMapa()\"> Mapa de la clase\n        </label>\n    </div>\n    <div *ngIf=\"vistaMapaDeLaClase\" class=\"btn-group btn-group-toggle\">\n        <label class=\"btn btn-outline-primary\">\n            <input type=\"radio\" name=\"options\" id=\"general\" (click)=\"cambiarAGeneral()\"> General\n        </label>\n        <label class=\"btn btn-outline-primary active\">\n            <input type=\"radio\" name=\"options\" id=\"mapa_de_clase\" (click)=\"cambiarAMapa()\" checked> Mapa de la clase\n        </label>\n    </div>\n</div>-->\n<br>\n<!--<div class=\"row justify-content-center\">\n    <div class=\"col-5\">\n        <div class=\"card-body\">\n            <h5 class=\"text-center card-title\">Actividades Completadas</h5>\n            <div class=\"card-content\">\n                <canvas id=\"usersConectados\"></canvas>\n                <h6 class=\"text-center\">{{porUsuariosConectados}}% Actividades Completadas</h6>\n            </div>\n        </div>\n    </div>\n</div>-->\n<!--<div class=\"row\">\n    <div class=\"card-body\">\n        <div class=\"row\">\n            <h5 class=\"col-4 text-center card-title\">Grafica</h5>\n            <div class=\"col-4\">\n                <div class=\"btn-group\">\n                    <button type=\"button\" class=\"btn btn-info dropdown-toggle\" data-toggle=\"dropdown\"\n                        aria-haspopup=\"true\" aria-expanded=\"false\">\n                        {{estadoSeleccionado}}\n                    </button>\n                    <div class=\"dropdown-menu\">\n                        <a class=\"dropdown-item\" *ngFor=\"let estado of estados\"\n                            (click)=\"seleccionarEstado(estado)\">{{estado}}</a>\n                    </div>\n                </div>\n            </div>\n            <div class=\"col-4\">\n                <div class=\"btn-group\">\n                    <button type=\"button\" class=\"btn btn-info dropdown-toggle\" data-toggle=\"dropdown\"\n                        aria-haspopup=\"true\" aria-expanded=\"false\">\n                        {{alumnoSeleccionado}}\n                    </button>\n                    <div class=\"dropdown-menu\">\n                        <a *ngIf=\"alumnoSeleccionadoAlumno\" class=\"dropdown-item\"\n                            (click)=\"seleccionarMediaAlumnos()\">Media de la clase</a>\n                        <a class=\"dropdown-item\" *ngFor=\"let alumno of alumnos\"\n                            (click)=\"seleccionarAlumno(alumno)\">{{alumno.estudiante.nombre}}</a>\n                    </div>\n                </div>\n            </div>\n        </div>\n    </div>\n</div>-->\n<!--<div *ngIf=\"vistaMapaDeLaClase\" class=\"row justify-content-md-center\">\n    <div class=\"card col-md-11\">\n        <div class=\"card-body\">\n            <h5 class=\"card-title\">Distribucion de la clase</h5>\n            <div id=\"clase\" class=\"example-boundary\">\n                <div id=\"{{item.id_item}}\" *ngFor=\"let item of actividad.alumnos\" class=\"example-box\"\n                    ondrop=\"myFunction(item)\" [cdkDragFreeDragPosition]=\"item.posicion\"\n                    cdkDragBoundary=\".example-boundary\" cdkDrag (cdkDragEnded)=\"dragEnded($event,item)\">\n                    {{item.estudiante.nombre}}\n                </div>\n            </div>\n        </div>\n    </div>\n</div>-->");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("#titulo {\n    color: #ECFFB0;\n    text-align: center;\n}\n\n.btn-circle {\n    width: 200px;\n    height: 200px;\n    padding: 6px 0px;\n    border-radius: 200px;\n    text-align: center;\n    font-size: 23px;\n    line-height: 1.42857;\n}\n\n.footer {\n    color: aliceblue;\n }\n\n.icono_rrss{\n    width: 15px;\n    height: 15px;\n }\n/*# sourceMappingURL=data:application/json;base64, */");
...
/* harmony import */ var _profesor_profesor_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./profesor/profesor.component */ "./src/app/profesor/profesor.component.ts");
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_profesor_profesor_component__WEBPACK_IMPORTED_MODULE_3__["ProfesorComponent"], { static: false })
...
/* harmony import */ var _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_48__ = __webpack_require__(/*! @fortawesome/angular-fontawesome */ "./node_modules/@fortawesome/angular-fontawesome/fesm2015/angular-fontawesome.js");
...
/* harmony import */ var _angular_platform_browser_animations__WEBPACK_IMPORTED_MODULE_51__ = __webpack_require__(/*! @angular/platform-browser/animations */ "./node_modules/@angular/platform-browser/fesm2015/animations.js");
/* harmony import */ var _profesor_profesor_component__WEBPACK_IMPORTED_MODULE_52__ = __webpack_require__(/*! ./profesor/profesor.component */ "./src/app/profesor/profesor.component.ts");
/* harmony import */ var _estudiante_estudiante_component__WEBPACK_IMPORTED_MODULE_53__ = __webpack_require__(/*! ./estudiante/estudiante.component */ "./src/app/estudiante/estudiante.component.ts");
/* harmony import */ var _profesor_sidenav_profesor_sidenav_profesor_component__WEBPACK_IMPORTED_MODULE_54__ = __webpack_require__(/*! ./profesor/sidenav-profesor/sidenav-profesor.component */ "./src/app/profesor/sidenav-profesor/sidenav-profesor.component.ts");
/* harmony import */ var _profesor_crear_actividad_crear_actividad_component__WEBPACK_IMPORTED_MODULE_55__ = __webpack_require__(/*! ./profesor/crear-actividad/crear-actividad.component */ "./src/app/profesor/crear-actividad/crear-actividad.component.ts");
/* harmony import */ var _profesor_ver_actividad_ver_actividad_component__WEBPACK_IMPORTED_MODULE_56__ = __webpack_require__(/*! ./profesor/ver-actividad/ver-actividad.component */ "./src/app/profesor/ver-actividad/ver-actividad.component.ts");
/* harmony import */ var _profesor_editar_actividad_editar_actividad_component__WEBPACK_IMPORTED_MODULE_57__ = __webpack_require__(/*! ./profesor/editar-actividad/editar-actividad.component */ "./src/app/profesor/editar-actividad/editar-actividad.component.ts");
/* harmony import */ var _profesor_crear_clase_crear_clase_component__WEBPACK_IMPORTED_MODULE_58__ = __webpack_require__(/*! ./profesor/crear-clase/crear-clase.component */ "./src/app/profesor/crear-clase/crear-clase.component.ts");
/* harmony import */ var _profesor_editar_clase_editar_clase_component__WEBPACK_IMPORTED_MODULE_59__ = __webpack_require__(/*! ./profesor/editar-clase/editar-clase.component */ "./src/app/profesor/editar-clase/editar-clase.component.ts");
/* harmony import */ var _profesor_ver_clase_ver_clase_component__WEBPACK_IMPORTED_MODULE_60__ = __webpack_require__(/*! ./profesor/ver-clase/ver-clase.component */ "./src/app/profesor/ver-clase/ver-clase.component.ts");
/* harmony import */ var _profesor_mensaje_mensaje_component__WEBPACK_IMPORTED_MODULE_61__ = __webpack_require__(/*! ./profesor/mensaje/mensaje.component */ "./src/app/profesor/mensaje/mensaje.component.ts");
/* harmony import */ var _profesor_ver_alumno_ver_alumno_component__WEBPACK_IMPORTED_MODULE_62__ = __webpack_require__(/*! ./profesor/ver-alumno/ver-alumno.component */ "./src/app/profesor/ver-alumno/ver-alumno.component.ts");
/* harmony import */ var _profesor_ver_estadisticas_clase_ver_estadisticas_clase_component__WEBPACK_IMPORTED_MODULE_63__ = __webpack_require__(/*! ./profesor/ver-estadisticas-clase/ver-estadisticas-clase.component */ "./src/app/profesor/ver-estadisticas-clase/ver-estadisticas-clase.component.ts");
...
AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
        declarations: [
            _app_component__WEBPACK_IMPORTED_MODULE_50__["AppComponent"],
            _profesor_profesor_component__WEBPACK_IMPORTED_MODULE_52__["ProfesorComponent"],
            _estudiante_estudiante_component__WEBPACK_IMPORTED_MODULE_53__["EstudianteComponent"],
            _profesor_sidenav_profesor_sidenav_profesor_component__WEBPACK_IMPORTED_MODULE_54__["SidenavProfesorComponent"],
            _profesor_crear_actividad_crear_actividad_component__WEBPACK_IMPORTED_MODULE_55__["CrearActividadComponent"],
            _profesor_ver_actividad_ver_actividad_component__WEBPACK_IMPORTED_MODULE_56__["VerActividadComponent"],
            _profesor_editar_actividad_editar_actividad_component__WEBPACK_IMPORTED_MODULE_57__["EditarActividadComponent"],
            _profesor_crear_clase_crear_clase_component__WEBPACK_IMPORTED_MODULE_58__["CrearClaseComponent"],
            _profesor_editar_clase_editar_clase_component__WEBPACK_IMPORTED_MODULE_59__["EditarClaseComponent"],
            _profesor_ver_clase_ver_clase_component__WEBPACK_IMPORTED_MODULE_60__["VerClaseComponent"],
            _profesor_mensaje_mensaje_component__WEBPACK_IMPORTED_MODULE_61__["MensajeComponent"],
            _profesor_ver_alumno_ver_alumno_component__WEBPACK_IMPORTED_MODULE_62__["VerAlumnoComponent"],
            _profesor_ver_estadisticas_clase_ver_estadisticas_clase_component__WEBPACK_IMPORTED_MODULE_63__["VerEstadisticasClaseComponent"],
        ],
        exports: [
            ...
            _angular_material_input__WEBPACK_IMPORTED_MODULE_24__["MatInputModule"],
            _profesor_mensaje_mensaje_component__WEBPACK_IMPORTED_MODULE_61__["MensajeComponent"],
            _fortawesome_angular_fontawesome__WEBPACK_IMPORTED_MODULE_48__["FontAwesomeModule"],
        ],
        imports: [
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("/* The sidebar menu */\n\n.sidenav {\n  height: 100%;\n  /* Full-height: remove this if you want \"auto\" height */\n  z-index: 1;\n  /* Stay on top */\n  top: auto;\n  /* Stay at the top */\n  left: 0;\n  background-color: #4A7B9D;\n  /* Black */\n  overflow-x: hidden;\n  /* Disable horizontal scroll */\n}\n\n/* The navigation menu links */\n\n.sidenav a {\n  padding: 6px 8px 6px 16px;\n  text-decoration: none;\n  font-size: 25px;\n  color: #ECFFB0;\n  display: block;\n}\n\n/* When you mouse over the navigation links, change their color */\n\n.sidenav a:hover {\n  color: #9AA899;\n}\n\n.circulo {\n  width: 10rem;\n  height: 10rem;\n  border-radius: 50%;\n  background: red;\n  display: -webkit-box;\n  display: flex;\n  -webkit-box-pack: center;\n          justify-content: center;\n  -webkit-box-align: center;\n          align-items: center;\n  text-align: center;\n}\n\n.circulo>p {\n  font-family: sans-serif;\n  color: white;\n  font-size: 1rem;\n  font-weight: bold;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("table {\n  width: 100%;\n}\n\n.example-container {\n  display: -webkit-box;\n  display: flex;\n  -webkit-box-orient: vertical;\n  -webkit-box-direction: normal;\n          flex-direction: column;\n  min-width: 300px;\n}\n\n.example-header {\n  min-height: 64px;\n  padding: 8px 24px 0;\n}\n\n.mat-form-field {\n  font-size: 14px;\n  width: 100%;\n}\n\n.mat-table {\n  overflow: auto;\n  max-height: 500px;\n}\n\n.example-box {\n  width: 70px;\n  height: 70px;\n  border: solid 1px #ccc;\n  color: rgba(0, 0, 0, 0.87);\n  cursor: move;\n  display: -webkit-inline-box;\n  display: inline-flex;\n  -webkit-box-pack: center;\n          justify-content: center;\n  -webkit-box-align: center;\n          align-items: center;\n  text-align: center;\n  background: #fff;\n  border-radius: 4px;\n  margin-right: 0px;\n  position: relative;\n  z-index: 1;\n  box-sizing: border-box;\n  padding: 10px;\n  -webkit-transition: box-shadow 200ms cubic-bezier(0, 0, 0.2, 1);\n  transition: box-shadow 200ms cubic-bezier(0, 0, 0.2, 1);\n  box-shadow: 0 3px 1px -2px rgba(0, 0, 0, 0.2), 0 2px 2px 0 rgba(0, 0, 0, 0.14), 0 1px 5px 0 rgba(0, 0, 0, 0.12);\n}\n\n.example-box:active {\n  box-shadow: 0 5px 5px -3px rgba(0, 0, 0, 0.2), 0 8px 10px 1px rgba(0, 0, 0, 0.14), 0 3px 14px 2px rgba(0, 0, 0, 0.12);\n}\n\n.example-boundary {\n  width: 400px;\n  height: 400px;\n  max-width: 100%;\n  border: dotted #ccc 2px;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
let CrearActividadComponent = class CrearActividadComponent {
    ...
    ponerAlumnos() {
        ...
        for (let i = 0; i < this.selection.selected.length; i++) {
            ...
            //MODIFICADO
            arryaAlumnos.push(new _Modelos_modelos__WEBPACK_IMPORTED_MODULE_5__["Alumnos"](this.selection.selected[i], { x: 0, y: 0 }, this.actividadCreate, null));
        }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("table {\n    width: 100%;\n  }\n  \n  .example-container {\n    display: -webkit-box;\n    display: flex;\n    -webkit-box-orient: vertical;\n    -webkit-box-direction: normal;\n            flex-direction: column;\n    min-width: 300px;\n  }\n  \n  .example-header {\n    min-height: 64px;\n    padding: 8px 24px 0;\n  }\n  \n  .mat-form-field {\n    font-size: 14px;\n    width: 100%;\n  }\n  \n  .mat-table {\n    overflow: auto;\n    max-height: 500px;\n  }\n  \n  .example-box {\n    width: 70px;\n    height: 70px;\n    border: solid 1px #ccc;\n    color: rgba(0, 0, 0, 0.87);\n    cursor: move;\n    display: -webkit-inline-box;\n    display: inline-flex;\n    -webkit-box-pack: center;\n            justify-content: center;\n    -webkit-box-align: center;\n            align-items: center;\n    text-align: center;\n    background: #fff;\n    border-radius: 4px;\n    margin-right: 0px;\n    position: relative;\n    z-index: 1;\n    box-sizing: border-box;\n    padding: 10px;\n    -webkit-transition: box-shadow 200ms cubic-bezier(0, 0, 0.2, 1);\n    transition: box-shadow 200ms cubic-bezier(0, 0, 0.2, 1);\n    box-shadow: 0 3px 1px -2px rgba(0, 0, 0, 0.2), 0 2px 2px 0 rgba(0, 0, 0, 0.14), 0 1px 5px 0 rgba(0, 0, 0, 0.12);\n  }\n  \n  .example-box:active {\n    box-shadow: 0 5px 5px -3px rgba(0, 0, 0, 0.2), 0 8px 10px 1px rgba(0, 0, 0, 0.14), 0 3px 14px 2px rgba(0, 0, 0, 0.12);\n  }\n  \n  .example-boundary {\n    width: 400px;\n    height: 400px;\n    max-width: 100%;\n    border: dotted #ccc 2px;\n  }\n/*# sourceMappingURL=data:application/json;base64, */");
...
let CrearClaseComponent = class CrearClaseComponent {
    ...
    ponerAlumnos() {
        ...
        for (let i = 0; i < this.selection.selected.length; i++) {
            ...
            //MODIFICADO
            arryaAlumnos.push(new _Modelos_modelos__WEBPACK_IMPORTED_MODULE_5__["AlumnosClase"](this.selection.selected[i], { x: 0, y: 0 }));
        }
        this.alumnosSeleccionados = arryaAlumnos;
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("table {\n    width: 100%;\n  }\n  \n  .example-container {\n    display: -webkit-box;\n    display: flex;\n    -webkit-box-orient: vertical;\n    -webkit-box-direction: normal;\n            flex-direction: column;\n    min-width: 300px;\n  }\n  \n  .example-header {\n    min-height: 64px;\n    padding: 8px 24px 0;\n  }\n  \n  .mat-form-field {\n    font-size: 14px;\n    width: 100%;\n  }\n  \n  .mat-table {\n    overflow: auto;\n    max-height: 500px;\n  }\n  \n  .example-box {\n    width: 70px;\n    height: 70px;\n    border: solid 1px #ccc;\n    color: rgba(0, 0, 0, 0.87);\n    cursor: move;\n    display: -webkit-inline-box;\n    display: inline-flex;\n    -webkit-box-pack: center;\n            justify-content: center;\n    -webkit-box-align: center;\n            align-items: center;\n    text-align: center;\n    background: #fff;\n    border-radius: 4px;\n    margin-right: 0px;\n    position: relative;\n    z-index: 1;\n    box-sizing: border-box;\n    padding: 10px;\n    -webkit-transition: box-shadow 200ms cubic-bezier(0, 0, 0.2, 1);\n    transition: box-shadow 200ms cubic-bezier(0, 0, 0.2, 1);\n    box-shadow: 0 3px 1px -2px rgba(0, 0, 0, 0.2), 0 2px 2px 0 rgba(0, 0, 0, 0.14), 0 1px 5px 0 rgba(0, 0, 0, 0.12);\n  }\n  \n  .example-box:active {\n    box-shadow: 0 5px 5px -3px rgba(0, 0, 0, 0.2), 0 8px 10px 1px rgba(0, 0, 0, 0.14), 0 3px 14px 2px rgba(0, 0, 0, 0.12);\n  }\n  \n  .example-boundary {\n    width: 400px;\n    height: 400px;\n    max-width: 100%;\n    border: dotted #ccc 2px;\n  }\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "EditarActividadComponent", function() { return EditarActividadComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm2015/forms.js");
...
let EditarActividadComponent = class EditarActividadComponent {
    constructor(_formBuilder) {
        this._formBuilder = _formBuilder;
        ...
        this.dataSource.data.forEach(row => {
            for (var i in this.editarActividad.alumnos) {
                if (this.editarActividad.alumnos[i].estudiante._id == row._id) {
                    ...
                    this.arrayAlumnosAntiguos.push(new _Modelos_modelos__WEBPACK_IMPORTED_MODULE_3__["Alumnos"](this.editarActividad.alumnos[i].estudiante, this.editarActividad.alumnos[i].posicion, this.editarActividad, this.editarActividad.alumnos[i].datos));
                }
            }
            //this.actualizarr(row);
    ...
    ponerAlumnos() {
        ...
        for (let i = 0; i < this.selection.selected.length; i++) {
            listaID[this.selection.selected[i]._id] = new _Modelos_modelos__WEBPACK_IMPORTED_MODULE_3__["Alumnos"](this.selection.selected[i], { x: 0, y: 0 }, this.editarActividad, null);
        }
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("table {\n    width: 100%;\n  }\n  \n  .example-container {\n    display: -webkit-box;\n    display: flex;\n    -webkit-box-orient: vertical;\n    -webkit-box-direction: normal;\n            flex-direction: column;\n    min-width: 300px;\n  }\n  \n  .example-header {\n    min-height: 64px;\n    padding: 8px 24px 0;\n  }\n  \n  .mat-form-field {\n    font-size: 14px;\n    width: 100%;\n  }\n  \n  .mat-table {\n    overflow: auto;\n    max-height: 500px;\n  }\n  \n  .example-box {\n    width: 70px;\n    height: 70px;\n    border: solid 1px #ccc;\n    color: rgba(0, 0, 0, 0.87);\n    cursor: move;\n    display: -webkit-inline-box;\n    display: inline-flex;\n    -webkit-box-pack: center;\n            justify-content: center;\n    -webkit-box-align: center;\n            align-items: center;\n    text-align: center;\n    background: #fff;\n    border-radius: 4px;\n    margin-right: 0px;\n    position: relative;\n    z-index: 1;\n    box-sizing: border-box;\n    padding: 10px;\n    -webkit-transition: box-shadow 200ms cubic-bezier(0, 0, 0.2, 1);\n    transition: box-shadow 200ms cubic-bezier(0, 0, 0.2, 1);\n    box-shadow: 0 3px 1px -2px rgba(0, 0, 0, 0.2), 0 2px 2px 0 rgba(0, 0, 0, 0.14), 0 1px 5px 0 rgba(0, 0, 0, 0.12);\n  }\n  \n  .example-box:active {\n    box-shadow: 0 5px 5px -3px rgba(0, 0, 0, 0.2), 0 8px 10px 1px rgba(0, 0, 0, 0.14), 0 3px 14px 2px rgba(0, 0, 0, 0.12);\n  }\n  \n  .example-boundary {\n    width: 400px;\n    height: 400px;\n    max-width: 100%;\n    border: dotted #ccc 2px;\n  }\n/*# sourceMappingURL=data:application/json;base64, */");
...
let EditarClaseComponent = class EditarClaseComponent {
        ...
        this.dataSource.data.forEach(row => {
            for (var i in this.editarActividad.alumnos) {
                if (this.editarActividad.alumnos[i].estudiante._id == row._id) {
                    this.selection.select(row);
                    this.actualizarr(row);
                    this.arrayAlumnosAntiguos.push(new _Modelos_modelos__WEBPACK_IMPORTED_MODULE_3__["AlumnosClase"](this.editarActividad.alumnos[i].estudiante, this.editarActividad.alumnos[i].posicion));
                }
            }
            //this.actualizarr(row);
            console.log(this.arryaAlumnos);
    ...
    actualizarr(item) {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.arryaAlumnos.push(new _Modelos_modelos__WEBPACK_IMPORTED_MODULE_3__["AlumnosClase"](item, { x: 0, y: 0 }));
            this.alumnosSeleccionados = this.arryaAlumnos;
            this.ponerAlumnos;
        });
    }
    ...
    ponerAlumnos() {
        ...
        for (let i = 0; i < this.selection.selected.length; i++) {
            listaID[this.selection.selected[i]._id] = new _Modelos_modelos__WEBPACK_IMPORTED_MODULE_3__["AlumnosClase"](this.selection.selected[i], { x: 0, y: 0 });
        }
        for (let j = 0; j < this.arrayAlumnosAntiguos.length; j++) {
            //console.log(listaID[this.arrayAlumnosAntiguos[j].estudiante._id])
            if (listaID[this.arrayAlumnosAntiguos[j].estudiante._id] != null) {
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiIuLi9hcHAvcHJvZmVzb3IvbWVuc2FqZS9tZW5zYWplLmNvbXBvbmVudC5jc3MifQ== */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("/* The sidebar menu */\n\n.sidenav {\n  z-index: 1;\n  /* Stay on top */\n  top: auto;\n  bottom: 0px;\n  /* Stay at the top */\n  left: 0;\n  background-color: #4A7B9D;\n  /* Black */\n  overflow-x: hidden;\n  /* Disable horizontal scroll */\n  height: 100vh;\n  /* Esto lo mantendra en su sitio */\n  top: 0;\n  left: 0;\n}\n\n/* The navigation menu links */\n\n.sidenav a {\n  padding: 6px 8px 6px 16px;\n  text-decoration: none;\n  font-size: 25px;\n  color: #ECFFB0;\n  display: block;\n}\n\n/* When you mouse over the navigation links, change their color */\n\n.sidenav a:hover {\n  color: #9AA899;\n}\n\n/* Style page content */\n\n.main {\n  margin-left: 160px;\n  /* Same as the width of the sidebar */\n  padding: 0px 10px;\n}\n\n/* On smaller screens, where height is less than 450px, change the style of the sidebar (less padding and a smaller font size) */\n\n@media screen and (max-height: 450px) {\n  .sidenav {\n    padding-top: 15px;\n  }\n  .sidenav a {\n    font-size: 18px;\n  }\n}\n\n.example-box {\n  width: 70px;\n  height: 70px;\n  border: solid 1px #ccc;\n  color: rgba(0, 0, 0, 0.87);\n  cursor: move;\n  display: -webkit-inline-box;\n  display: inline-flex;\n  -webkit-box-pack: center;\n          justify-content: center;\n  -webkit-box-align: center;\n          align-items: center;\n  text-align: center;\n  background: #fff;\n  border-radius: 4px;\n  margin-right: 0px;\n  position: relative;\n  z-index: 1;\n  box-sizing: border-box;\n  padding: 10px;\n  -webkit-transition: box-shadow 200ms cubic-bezier(0, 0, 0.2, 1);\n  transition: box-shadow 200ms cubic-bezier(0, 0, 0.2, 1);\n  box-shadow: 0 3px 1px -2px rgba(0, 0, 0, 0.2), 0 2px 2px 0 rgba(0, 0, 0, 0.14), 0 1px 5px 0 rgba(0, 0, 0, 0.12);\n}\n\n.example-box:active {\n  box-shadow: 0 5px 5px -3px rgba(0, 0, 0, 0.2), 0 8px 10px 1px rgba(0, 0, 0, 0.14), 0 3px 14px 2px rgba(0, 0, 0, 0.12);\n}\n\n.example-boundary {\n  width: 400px;\n  height: 400px;\n  max-width: 100%;\n  border: dotted #ccc 2px;\n}\n\n#snackbar {\n  visibility: hidden;\n  min-width: 250px;\n  margin-left: -125px;\n  background-color: #333;\n  color: #fff;\n  text-align: center;\n  border-radius: 2px;\n  padding: 16px;\n  position: fixed;\n  z-index: 1;\n  left: 50%;\n  bottom: 30px;\n  font-size: 17px;\n}\n\n#snackbar.show {\n  visibility: visible;\n  -webkit-animation: fadein 0.5s, fadeout 0.5s 2.5s;\n  animation: fadein 0.5s, fadeout 0.5s 2.5s;\n}\n\n@-webkit-keyframes fadein {\n  from {\n    bottom: 0;\n    opacity: 0;\n  }\n  to {\n    bottom: 30px;\n    opacity: 1;\n  }\n}\n\n@keyframes fadein {\n  from {\n    bottom: 0;\n    opacity: 0;\n  }\n  to {\n    bottom: 30px;\n    opacity: 1;\n  }\n}\n\n@-webkit-keyframes fadeout {\n  from {\n    bottom: 30px;\n    opacity: 1;\n  }\n  to {\n    bottom: 0;\n    opacity: 0;\n  }\n}\n\n@keyframes fadeout {\n  from {\n    bottom: 30px;\n    opacity: 1;\n  }\n  to {\n    bottom: 0;\n    opacity: 0;\n  }\n}\n\n.btn-circle {\n  width: 200px;\n  height: 200px;\n  padding: 6px 0px;\n  border-radius: 200px;\n  text-align: center;\n  font-size: 23px;\n  line-height: 1.42857;\n}\n/*# sourceMappingURL=data:application/json;base64, */");
...
/* harmony import */ var _ver_clase_ver_clase_component__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./ver-clase/ver-clase.component */ "./src/app/profesor/ver-clase/ver-clase.component.ts");
...
let ProfesorComponent = class ProfesorComponent {
    constructor(matDialog, estudiantes, _snackBar) {
        ...
        this.creandoActividadAsociada = false;
        //Tabla de estudiantes
        this.displayedColumnsEstudiantes = ['nombre', 'apellidos', 'clase', 'estadisticas', 'acciones'];
        //Tabla de actividades
        this.displayedColumnsActividades = ['nombre', 'profesor', 'clase', 'estado', 'acciones', 'editarborrar'];
        //Tabla de clases
    ...
    ngOnInit() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            yield $.getJSON("/verActividades", function (data) {
                //console.log(data);
                ju.listaActividades = data;
    ...
    applyFilterE(filterValue) {
        filterValue = filterValue.trim(); // Remove whitespace
        filterValue = filterValue.toLowerCase(); // Datasource defaults to lowercase matches
        this.dataSourceEstudiantes.filter = filterValue;
    }
    applyFilterC(filterValue) {
        filterValue = filterValue.trim(); // Remove whitespace
        filterValue = filterValue.toLowerCase(); // Datasource defaults to lowercase matches
...
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_ver_clase_ver_clase_component__WEBPACK_IMPORTED_MODULE_6__["VerClaseComponent"], { static: false })
], ProfesorComponent.prototype, "verClaseComp", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material__WEBPACK_IMPORTED_MODULE_10__["MatPaginator"], null)
], ProfesorComponent.prototype, "paginatorE", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material__WEBPACK_IMPORTED_MODULE_10__["MatSort"], null)
], ProfesorComponent.prototype, "sortE", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material__WEBPACK_IMPORTED_MODULE_10__["MatPaginator"], null)
], ProfesorComponent.prototype, "paginatorA", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material__WEBPACK_IMPORTED_MODULE_10__["MatSort"], null)
], ProfesorComponent.prototype, "sortA", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material__WEBPACK_IMPORTED_MODULE_10__["MatPaginator"], null)
], ProfesorComponent.prototype, "paginatorC", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material__WEBPACK_IMPORTED_MODULE_10__["MatSort"], null)
], ProfesorComponent.prototype, "sortC", void 0);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("/* The sidebar menu */\n.sidenav {\n    height: 100%; /* Full-height: remove this if you want \"auto\" height */\n    position: fixed; /* Fixed Sidebar (stay in place on scroll) */\n    z-index: 1; /* Stay on top */\n    top: auto; /* Stay at the top */\n    left: 0;\n    background-color: #4A7B9D; /* Black */\n    overflow-x: hidden; /* Disable horizontal scroll */\n    padding-top: 20px;\n  }\n/* The navigation menu links */\n.sidenav a {\n    padding: 6px 8px 6px 16px;\n    text-decoration: none;\n    font-size: 25px;\n    color: #ECFFB0;\n    display: block;\n  }\n/* When you mouse over the navigation links, change their color */\n.sidenav a:hover {\n    color: #9AA899;\n  }\n/* Style page content */\n.main {\n    margin-left: 160px; /* Same as the width of the sidebar */\n    padding: 0px 10px;\n  }\n/* On smaller screens, where height is less than 450px, change the style of the sidebar (less padding and a smaller font size) */\n@media screen and (max-height: 450px) {\n    .sidenav {padding-top: 15px;}\n    .sidenav a {font-size: 18px;}\n  }\n/*# sourceMappingURL=data:application/json;base64, */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = (".example-box {\n  width: 70px;\n  height: 70px;\n  border: solid 1px #ccc;\n  color: rgba(0, 0, 0, 0.87);\n  cursor: move;\n  display: -webkit-inline-box;\n  display: inline-flex;\n  -webkit-box-pack: center;\n          justify-content: center;\n  -webkit-box-align: center;\n          align-items: center;\n  text-align: center;\n  background: #fff;\n  border-radius: 4px;\n  margin-right: 0px;\n  position: relative;\n  z-index: 1;\n  box-sizing: border-box;\n  padding: 10px;\n  -webkit-transition: box-shadow 200ms cubic-bezier(0, 0, 0.2, 1);\n  transition: box-shadow 200ms cubic-bezier(0, 0, 0.2, 1);\n  box-shadow: 0 3px 1px -2px rgba(0, 0, 0, 0.2), 0 2px 2px 0 rgba(0, 0, 0, 0.14), 0 1px 5px 0 rgba(0, 0, 0, 0.12);\n}\n\n.example-box:active {\n  box-shadow: 0 5px 5px -3px rgba(0, 0, 0, 0.2), 0 8px 10px 1px rgba(0, 0, 0, 0.14), 0 3px 14px 2px rgba(0, 0, 0, 0.12);\n}\n\n.example-boundary {\n  width: 400px;\n  height: 400px;\n  max-width: 100%;\n  border: dotted #ccc 2px;\n}\n\n.btn-circle2 {\n  width: 50px;\n  height: 50px;\n  padding: 6px 0px;\n  border-radius: 50px;\n  text-align: center;\n  font-size: 15px;\n  line-height: 1.42857;\n}\n\n.item {\n  width: 80px;\n  height: 80px;\n  background-color:rgba(255, 255, 255, 0.267);\n  cursor: move;\n  display: -webkit-inline-box;\n  display: inline-flex;\n  -webkit-box-pack: center;\n          justify-content: center;\n  -webkit-box-align: center;\n          align-items: center;\n  text-align: center;\n  z-index: 1;\n  border-radius: 50%;\n}\n\n/*# sourceMappingURL=data:application/json;base64, */");
...
let VerActividadComponent = class VerActividadComponent {
    ...
    constructor(profesor) {
        ...
        this.estados = [
            { nombre: 'alegria', checked: true },
            { nombre: 'asco', checked: true },
            { nombre: 'miedo', checked: false },
            { nombre: 'sorpresa', checked: false },
            { nombre: 'tristeza', checked: false },
            { nombre: 'ira', checked: false },
            { nombre: 'pulsaciones', checked: false },
            { nombre: 'distraido', checked: false },
    ...
    cargarGraficas() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            this.vistaGeneral = yield true;
            this.alumnos = this.actividad.alumnos;
            this.alumnosSelect.length = 0;
            this.alumnosSelect.push({ nombre: 'Media de todos', id: '', checked: false });
            for (let i = 0; i < this.actividad.alumnos.length; i++) {
            ...
            this.usersConectadosGraf = yield new chart_js__WEBPACK_IMPORTED_MODULE_2__["Chart"]('usersConectados', this.configUsersConectados);
            //Grafica Lineal 
            /*this.configuracionGraficaLineal = {
              type: 'line',
              data: {
    ...
    insertarDatos(datos) {
        ...
        for (let i = 0; i < this.alumnosTabla.length; i++) {
            if (datos.id_item == this.alumnosTabla[i].id_item) {
    ...
    insertarResumen() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            this.datosResumenSeleccionados.alegria = (this.resumen.alegria / sumaTotalEmociones);
            this.datosResumenSeleccionados.asco = (this.resumen.asco / sumaTotalEmociones);
            this.datosResumenSeleccionados.ira = (this.resumen.ira / sumaTotalEmociones);
            this.datosResumenSeleccionados.miedo = (this.resumen.miedo / sumaTotalEmociones);
            this.datosResumenSeleccionados.sorpresa = (this.resumen.sorpresa / sumaTotalEmociones);
            this.datosResumenSeleccionados.tristeza = (this.resumen.tristeza / sumaTotalEmociones);
            ...
            this.datosResumenSeleccionados.concentrado = (this.resumen.concentrado / sumaTotalEstadoDisConc);
            this.datosResumenSeleccionados.distraido = (this.resumen.distraido / sumaTotalEstadoDisConc);
            ...
            this.datosResumenSeleccionados.motivado = (this.resumen.motivado / sumaTotalEstadoFrusMotiv);
            this.datosResumenSeleccionados.frustrado = (this.resumen.frustrado / sumaTotalEstadoFrusMotiv);
...
VerActividadComponent.ctorParameters = () => [
...
VerActividadComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        ...
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./ver-actividad.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/profesor/ver-actividad/ver-actividad.component.html")).default,
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiIuLi9hcHAvcHJvZmVzb3IvdmVyLWFsdW1uby92ZXItYWx1bW5vLmNvbXBvbmVudC5jc3MifQ== */");
...
let VerAlumnoComponent = class VerAlumnoComponent {
    constructor(profesor) {
        this.profesor = profesor;
        this.estados = [
            { nombre: 'alegria' },
        ...
        this.configGrafEstados = {
            ...
            data: {
                datasets: [
                    {
                        type: 'line',
                        label: 'Pulsaciones de ' + this.alumno.nombre,
                        ...
                        type: 'bar',
                        label: 'Datos ' + this.estadoSeleccionado + ' de ' + this.alumno.nombre,
...
VerAlumnoComponent.ctorParameters = () => [
    { type: _profesor_component__WEBPACK_IMPORTED_MODULE_2__["ProfesorComponent"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], VerAlumnoComponent.prototype, "alumno", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material__WEBPACK_IMPORTED_MODULE_5__["MatPaginator"], null)
], VerAlumnoComponent.prototype, "paginator", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material__WEBPACK_IMPORTED_MODULE_5__["MatSort"], null)
], VerAlumnoComponent.prototype, "sort", void 0);
VerAlumnoComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-ver-alumno',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./ver-alumno.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/profesor/ver-alumno/ver-alumno.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./ver-alumno.component.css */ "./src/app/profesor/ver-alumno/ver-alumno.component.css")).default]
    })
], VerAlumnoComponent);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiIuLi9hcHAvcHJvZmVzb3IvdmVyLWNsYXNlL3Zlci1jbGFzZS5jb21wb25lbnQuY3NzIn0= */");
...
/* harmony import */ var _profesor_component__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ../profesor.component */ "./src/app/profesor/profesor.component.ts");
...
let VerClaseComponent = class VerClaseComponent {
    constructor(profesor, _snackBar) {
        this.profesor = profesor;
        this._snackBar = _snackBar;
        this.actividades = [];
        this.actividad = null;
...
VerClaseComponent.ctorParameters = () => [
    { type: _profesor_component__WEBPACK_IMPORTED_MODULE_3__["ProfesorComponent"] },
    { type: _angular_material_snack_bar__WEBPACK_IMPORTED_MODULE_4__["MatSnackBar"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], VerClaseComponent.prototype, "clase", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material__WEBPACK_IMPORTED_MODULE_5__["MatPaginator"], null)
], VerClaseComponent.prototype, "paginatorA", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material__WEBPACK_IMPORTED_MODULE_5__["MatSort"], null)
], VerClaseComponent.prototype, "sortA", void 0);
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony default export */ __webpack_exports__["default"] = ("\n/*# sourceMappingURL=data:application/json;base64,eyJ2ZXJzaW9uIjozLCJzb3VyY2VzIjpbXSwibmFtZXMiOltdLCJtYXBwaW5ncyI6IiIsImZpbGUiOiIuLi9hcHAvcHJvZmVzb3IvdmVyLWVzdGFkaXN0aWNhcy1jbGFzZS92ZXItZXN0YWRpc3RpY2FzLWNsYXNlLmNvbXBvbmVudC5jc3MifQ== */");
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "VerEstadisticasClaseComponent", function() { return VerEstadisticasClaseComponent; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! tslib */ "./node_modules/tslib/tslib.es6.js");
/* harmony import */ var _angular_core__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @angular/core */ "./node_modules/@angular/core/fesm2015/core.js");
/* harmony import */ var _ver_clase_ver_clase_component__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../ver-clase/ver-clase.component */ "./src/app/profesor/ver-clase/ver-clase.component.ts");
/* harmony import */ var chart_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! chart.js */ "./node_modules/chart.js/dist/Chart.js");
/* harmony import */ var chart_js__WEBPACK_IMPORTED_MODULE_3___default = /*#__PURE__*/__webpack_require__.n(chart_js__WEBPACK_IMPORTED_MODULE_3__);
/* harmony import */ var _angular_cdk_collections__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/cdk/collections */ "./node_modules/@angular/cdk/esm2015/collections.js");
/* harmony import */ var _angular_material__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! @angular/material */ "./node_modules/@angular/material/esm2015/material.js");
...
let VerEstadisticasClaseComponent = class VerEstadisticasClaseComponent {
    constructor(verClase) {
...
VerEstadisticasClaseComponent.ctorParameters = () => [
    { type: _ver_clase_ver_clase_component__WEBPACK_IMPORTED_MODULE_2__["VerClaseComponent"] }
];
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Input"])()
], VerEstadisticasClaseComponent.prototype, "clase", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material__WEBPACK_IMPORTED_MODULE_5__["MatPaginator"], null)
], VerEstadisticasClaseComponent.prototype, "paginator", void 0);
tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChild"])(_angular_material__WEBPACK_IMPORTED_MODULE_5__["MatSort"], null)
], VerEstadisticasClaseComponent.prototype, "sort", void 0);
VerEstadisticasClaseComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
    Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
        selector: 'app-ver-estadisticas-clase',
        template: tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! raw-loader!./ver-estadisticas-clase.component.html */ "./node_modules/raw-loader/dist/cjs.js!./src/app/profesor/ver-estadisticas-clase/ver-estadisticas-clase.component.html")).default,
        styles: [tslib__WEBPACK_IMPORTED_MODULE_0__["__importDefault"](__webpack_require__(/*! ./ver-estadisticas-clase.component.css */ "./src/app/profesor/ver-estadisticas-clase/ver-estadisticas-clase.component.css")).default]
    })
