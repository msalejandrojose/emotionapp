...
let VerActividadComponent = class VerActividadComponent {
    ...
    constructor(profesor) {
        ...
        this.estados = [
            ...
            { nombre: 'sorpresa', checked: true, color: [89, 189, 255] },
            { nombre: 'tristeza', checked: false, color: [81, 81, 255] },
            { nombre: 'ira', checked: true, color: [255, 0, 0] },
    ...
    cargarGraficas() {
        return tslib__WEBPACK_IMPORTED_MODULE_0__["__awaiter"](this, void 0, void 0, function* () {
            ...
            for (let i = 0; i < this.actividad.alumnos.length; i++) {
                this.alumnosSelect.push({ nombre: this.actividad.alumnos[i].estudiante.nombre, id: this.actividad.alumnos[i].estudiante._id, checked: true });
            }
