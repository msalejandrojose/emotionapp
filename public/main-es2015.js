...
let ProfesorComponent = class ProfesorComponent {
    constructor(matDialog, estudiantes, _snackBar, component) {
        ...
        this.displayedColumnsEstudiantes = ['nombre', 'apellidos', 'clase', 'estadisticas', 'acciones', 'borrar'];
        //Tabla de actividades
        this.displayedColumnsActividades = ['nombre', 'profesor', 'clase', 'estado', 'acciones', 'editar', 'borrar'];
        //Tabla de clases
        this.displayedColumnsClases = ['nombre', 'profesor', 'accion1', 'accion2', 'accion3', 'editar', 'borrar'];
