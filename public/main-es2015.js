...
let VerActividadComponent = class VerActividadComponent {
    ...
    constructor(profesor) {
        ...
        //Tabla de estudiantes
        this.displayedColumnsAlumnos = ['nombre', 'estado', 'pulsaciones', 'webcam', 'pulsera', 'led'];
        //Tabla de alumnos
        this.alumnosTabla = [];
